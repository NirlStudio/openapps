...
class NirlAutoMapService {
    ...
    protected static function getMethod($action) {
    ...
    protected static function responseJSON($result) {
...
class NirlPublicService extends NirlAutoMapService{
    ...
    public function process($action=NULL, $useSession=FALSE) {
        ...
        // by default, response result as JSON string.
...
class NirlServiceGroup {
    ...
    /**
     * this field will be used to save the map of method name to its implementation.
...
class NirlFileService {
    ...
    protected static function saveFile($userid, $file) {
        ...
        $fileid = static::writeFile($userid, $path, $name, $type, $size, $desturi);
        if ( empty($fileid) ) 
            self::internalError($userid, $name . '-' . $type . '-' . $size, 
                                'failed to save file.');
    ...
    protected static function writeFile($userid, $path, $name, $type, $size, $desturi) {
