...
include_once dirname(__FILE__).'/NirlMemcached.php';
...
class NirlShield {
    ...
    /*  array(
            'event_name' => array( // the name of event.
                'seconds'=>600,    // time span for counting.
                'limit'=>600),     // counter limitation.
             , ...
        )
    */
    ...
    public static function trying($event_name, $entity_id) {
        ...
        if ( !is_empty($mc->get("NSH:B:$entity_id")) ) {
     ...
     */
    public static function invalidCall($userid=0) {
        
        // detect by user id.
        if ( !empty($userid) )
            self::trying('invalidCallUser', $userid);
     ...
     */
    public static function internalError($userid=0) {
